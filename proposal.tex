...
My final contribution extends the schedule and layout transformation frameworks to support sparse codes.
\end{abstract}
...
I begin with an example of how to use RAJA. I will be converting a standard C++ implementation of the \verb.HYDRO_2D. benchmark into RAJA. 
...
\todo{add figures from \cite{neth2021inter}}
...
\begin{itemize}
    ...
    \item How do we efficiently estimate the cost of choosing different sparse formats and schedules?
