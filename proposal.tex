...
Before moving to the research plan (\Cref{Sec:Plan}), the limitations of my proposed approach (\Cref{Sec:Limitations}), my proposed schedule (\Cref{Sec:Schedule}), and my data plan (\Cref{Sec:DataPlan}), I give a short introductory example of how code using the RAJA library is written.
...
In \Cref{Sec:Work1} I describe an interface for specifying schedule transformations across multiple kernels in RAJA, such as loop fusion and overlapped tiling. 
...
In \Cref{Sec:Work2} I describe a related interface for specifying data transformations between kernels in a declarative fashion. 
...
In \Cref{Sec:Work3} I describe an approach to incorporating support for sparse data formats into the two previous interfaces. 
...
\centering 
    \begin{subfigure}{.2\textwidth}
        \centering
        \includegraphics[width=\textwidth]{row-and-column-major-order.png}
    ...
    \begin{subfigure}{.75\textwidth}
        \centering
        \includegraphics[width=\textwidth]{A-comparison-of-the-Array-of-Structs-AoS-and-Struct-of-Arrays-SoA-memory-layouts.png}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth,trim={0 0 0 0cm},clip]{Compressed-Sparse-Row-CSR-sparse-matrix-format-The-val-array-stores-the-nonzeros-by.png}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{csf-formats.png}
...
\includegraphics[height=1.8in]{lassenPerfPlot1.pdf}
\caption{Normalized execution time for the 2MM and 3MM kernels across different variants.}
\label{perfplot1}
\end{subfigure}
~~
\begin{subfigure}{0.45\textwidth}
    \includegraphics[height=1.8in]{lassenPerfPlot2.pdf}
